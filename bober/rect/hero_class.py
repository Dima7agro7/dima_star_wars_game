...
class Player(pygame.sprite.Sprite):  # наследуем класс от класса спрайтов
    ...
    def __init__(self, w, h, number_image=1,
                 k_move_forward=pygame.K_w,
                 k_move_backward=pygame.K_s,
        ...
        self.k_move_forward, self.k_move_backward, self.k_move_left, self.k_move_right, self.k_shoot = (
            k_move_forward, k_move_backward, k_move_left, k_move_right, k_shoot
        )
